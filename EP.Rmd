...
#Simulação
## Tamanho da amostra
Gráfico para vários tamanhos de amostra:
```{r tam_amostra, echo = FALSE}
testeAmostras(n = 8, c(25, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800), p = 0.4)
```
...
testeSamplesT(range_n = 8:9, sampleSz = N, p = 0.4)
```

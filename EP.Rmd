...
Ao realizarmos os testes, percebemos que a nossa aparenta ter formas de algumas distribuições conhecidas, sendo eals: Poisson, Exponencial e Geométrica. Neste caso vamos tentar identificar quais paramêtros de cada uma destas distribuições.

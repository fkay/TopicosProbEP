...
##IMAGEM DAS DUAS DISTRIBUICOES AQUI

Legenda
Azul: Distribuição da simulação reescalada
Roxo: Distribuição da simulação original

Foi necessario reescalar a distribuição e retirar dados pois a mesma iria interferir na comparação com uma distribuição já conhecida. Portanto
